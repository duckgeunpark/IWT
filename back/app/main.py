...
from app.api.v1.endpoints import user_auth0, photo_route, llm_route, post_route, image_metadata, social_route, search_route, photo_filter_route, directions_route, notification_route, llm_preference_route, admin_route, admin_users_route, admin_posts_route, admin_places_route, agent_route
...
def setup_routers(app: FastAPI) -> None:
    ...
    app.include_router(
        admin_users_route.router,
        prefix=api_prefix,
        tags=["관리자-사용자"]
    )
    app.include_router(
        admin_posts_route.router,
        prefix=api_prefix,
        tags=["관리자-게시글"]
    )
    app.include_router(
        admin_places_route.router,
        prefix=api_prefix,
        tags=["관리자-Place"]
    )
    app.include_router(
